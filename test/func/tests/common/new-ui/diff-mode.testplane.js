            ...
            describe('Diff mode', () => {
                ...
                describe('Suites page', () => {
                    it('should use config value as default diff mode', async ({browser}) => {
                        ...
                        const selectText = await getSelectText(browser, 'diff-mode-select');
                    ...
                    it('should preserve diff mode after page refresh', async ({browser}) => {
                        ...
                        await selectDiffModeOption(browser, 'diff-mode-select', 'Switch');

                        const selectTextBefore = await getSelectText(browser, 'diff-mode-select');
                        expect(selectTextBefore).toContain('Switch');

                        await browser.refresh();
                        await navigateToFailedTest(browser);

                        const selectTextAfter = await getSelectText(browser, 'diff-mode-select');
                ...
                describe('Visual checks page', () => {
                    ...
                    it('should preserve diff mode after page refresh', async ({browser}) => {
                        ...
                        await selectDiffModeOption(browser, 'diff-mode-select', 'Swipe');
