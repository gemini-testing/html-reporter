...
describe('lib/adapters/test/playwright', () => {
    ...
    describe('original', () => {
        it('shoult return original test instance', () => {
            ...
            assert.equal(PlaywrightTestAdapter.create(test).original, test);
        });
    });
    ...
    (['pending', 'disabled', 'silentlySkipped'] as const).forEach(fieldName => {
        describe(fieldName, () => {
    ...
    describe('fullName', () => {
        it('should return title from original test', () => {
            ...
            assert.equal(PlaywrightTestAdapter.create(test).fullName, 'title');
        });
    });
