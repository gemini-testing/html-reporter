...
module.exports = class TestAdapter {
    static create(testResult = {}, hermione, status, saveAttempt = true) {
        return new this(testResult, hermione, status, saveAttempt);
    }

    constructor(testResult, hermione, status, saveAttempt) {
    ...
    _getImgFromStorage(imgPath) {
        return globalCacheAllImages.get(imgPath);
    }
