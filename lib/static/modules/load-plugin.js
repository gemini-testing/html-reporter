...
async function initPlugin(plugin, pluginName) {
    try {
        ...
        if (Array.isArray(plugin)) {
            ...
            const selectorsTree = await import('./selectors/tree');
            const selectorsHelper = await import('./selectors/selectorsHelper');
            return plugin(...depArgs, {pluginName, actions, selectors: {selectorsTree, selectorsHelper}});
        }
