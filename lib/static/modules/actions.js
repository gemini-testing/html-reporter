...
import {fetchDataFromDatabases, mergeDatabases, connectToDatabase, getMainDatabaseUrl, getSuitesTableRows} from '../../sqlite-utils/client';
...
export const toggleErrorGroup = (payload) => ({type: actionNames.TOGGLE_ERROR_GROUP, payload});
