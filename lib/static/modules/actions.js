...
export const acceptOpened = (fails, type = actionNames.ACCEPT_OPENED_SCREENSHOTS) => {
...
export const acceptTest = (suite, browserId, stateName) => {
    return acceptOpened(assign({browserId, stateName}, suite), actionNames.ACCEPT_SCREENSHOT);
};
