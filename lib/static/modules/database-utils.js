            ...
            browsers: [
                {
                    ...
                    result: {
                        attempt: attempt[dbColumnNames.timestamp], // timestamp corresponds to attempt number -- every next test retry will have bigger timestamp (just like every next test retry has bigger attempt number)
