...
import {SUITES_PAGE_DIFF_MODE_KEY} from '../../../constants/local-storage';
...
export default (state, action) => {
    switch (action.type) {
        ...
        case actionNames.INIT_STATIC_REPORT: {
            ...
            const suitesPageDiffMode = localStorageWrapper.getItem(SUITES_PAGE_DIFF_MODE_KEY, diffMode);

            return {...state, view: {...state.view, viewMode, baseHost, ...lsView, ...viewQuery, diffMode: suitesPageDiffMode}};
        }
