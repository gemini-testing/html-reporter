...
export default produce((state, action) => {
    switch (action.type) {
        ...
        case actionNames.INIT_STATIC_REPORT: {
            const {scaleImages, baseHost, defaultView: viewMode} = state.config;
            ...
            state.view = {...state.view, scaleImages, viewMode, baseHost, ...lsView, ...viewQuery};
        ...
        case actionNames.VIEW_THREE_UP_DIFF:
            state.view.diffMode = diffModes.THREE_UP;
            break;

        case actionNames.VIEW_ONLY_DIFF:
            state.view.diffMode = diffModes.ONLY_DIFF;
            break;

        case actionNames.VIEW_SWITCH_DIFF:
            state.view.diffMode = diffModes.SWITCH;
            break;

        case actionNames.VIEW_SWIPE_DIFF:
            state.view.diffMode = diffModes.SWIPE;
            break;

        case actionNames.VIEW_ONION_SKIN_DIFF:
            state.view.diffMode = diffModes.ONION_SKIN;
            break;
    }
});
