...
export default ((state, action) => {
    ...
    switch (action.type) {
        ...
        case actionNames.SELECT_ALL: {
            changeVisibleNodesState(state.tree, {checkStatus: CHECKED}, diff.tree);

            return applyStateUpdate(state, diff);
        }

        case actionNames.DESELECT_ALL: {
            changeVisibleNodesState(state.tree, {checkStatus: UNCHECKED}, diff.tree);
...
function changeVisibleNodesState(tree, state, diff = tree) {
