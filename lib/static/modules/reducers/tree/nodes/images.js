...
export function changeImageStatus(tree, imageId, status, diff = tree) {
    ensureDiffProperty(diff, ['images', 'byId']);

    changeNodeState(tree.images.byId, imageId, {status}, diff.images.byId);
}
