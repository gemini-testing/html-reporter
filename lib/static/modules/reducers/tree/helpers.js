 ...
 */
export function updateImagesStatus({tree, view, app, images, imageIdsArray, newStatus, diff = tree}) {
    const resultIds = [];
    const browserIds = [];
    ...
    !isEmpty(browserIdsUniq) && calcBrowsersShowness({tree, view, app, browserIds: browserIdsUniq, diff});
