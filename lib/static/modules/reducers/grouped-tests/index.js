...
export default (state, action) => {
    switch (action.type) {
        ...
        case actionNames.COMMIT_REVERTED_IMAGES_TO_TREE: {
            const {
                tree, groupedTests,
                view: {keyToGroupTestsBy, strictMatchFilter},
                app: {suitesPage: {viewMode, filteredBrowsers, nameFilter, useMatchCaseFilter, useRegexFilter}}
            } = state;
            const viewArgs = {viewMode, filteredBrowsers, nameFilter, useMatchCaseFilter, useRegexFilter, strictMatchFilter};
