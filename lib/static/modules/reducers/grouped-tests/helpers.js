...
export function handleActiveResults({tree = {}, viewMode = ViewMode.ALL, filteredBrowsers = [], testNameFilter = '', strictMatchFilter = false, useRegexFilter = false, useMatchCaseFilter = false, resultCb}) {
    ...
    for (const result of results) {
        ...
        if (!isTestNameMatchFilters(testName, browser.name, testNameFilter, strictMatchFilter, useMatchCaseFilter, useRegexFilter)) {
            continue;
        }
