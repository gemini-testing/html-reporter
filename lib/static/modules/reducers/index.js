...
export default (state, action) => {
    // Ignore screenshot edits while processing or previewing the cached tree.
    if ((state?.processing || state?.app?.isGuiInitializing) && staticAccepterEditingActions.has(action.type)) {
        return state;
    }
