import {last, initial, identity, flatMap, isEmpty, find, compact} from 'lodash';
...
import {isNodeFailed, isAcceptable} from '../utils';
...
export function shouldShowBrowser(browser, filteredBrowsers, errorGroupBrowserIds = []) {
    ...
    return browser.versions.some((browserVersion) => browserVersionsToFilterBy.includes(browserVersion));
}
