(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('showOnlyErrors').addEventListener('click', toggleVisibility);
        document.getElementById('showOnlyDiff').addEventListener('click', toggleVisibility);
