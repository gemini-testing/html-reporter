...
class Screenshot extends Component {
    ...
    render() {
        ...
        const elem = <div onClick={diffBounds && this._handleDiffClick(diffBounds)} className="image-box__screenshot image-box__screenshot_fixed-size" style={{width: imgSize.width, paddingTop: `${paddingTop}%`, 'backgroundImage': `url(${url})`}} />;
