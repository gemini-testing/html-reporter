...
class Screenshot extends Component {
    ...
    render() {
        ...
        const elem = <div className="image-box__screenshot image-box__screenshot_fixed-size" style={{width: imgSize.width, paddingTop: `${paddingTop}%`, 'background-image': `url(${url})`}} />;
