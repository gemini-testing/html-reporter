...
class Suites extends Component {
    ...
    render() {
        const {suites, suiteIds, testNameFilter, filteredBrowsers, lazyLoadOffset, errorGroupTests, dbStats, useSqlite} = this.props;
        ...
        const dbStatsComponent = useSqlite ? <DbStats stats={dbStats} /> : null;
        return (
