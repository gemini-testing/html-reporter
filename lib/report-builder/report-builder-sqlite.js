...
module.exports = class ReportBuilderSqliteGui extends ReportBuilder {
    static async create(hermione, pluginConfig) {
        const reportBuilder = new ReportBuilderSqliteGui(hermione, pluginConfig);
    ...
    _addTestResult(formattedResult, props) {
        ...
        this._writeTestResultToDb(testResult, formattedResult);
        // if (testResult.status !== IDLE && testResult.status !== RUNNING) {
        // }
