...
module.exports = class StaticReportBuilder {
    ...
    _createTestResult(result, props) {
        const {
            sets, browserId, suite, sessionId, description, imagesInfo, screenshot, multipleTabs, errorDetails
        } = result;
        ...
        const testResult = Object.assign({
            sets, suiteUrl, name: browserId, metaInfo, description, imagesInfo,
