...
exports.renameDatabaseForReuse = (reportPath) => {
    try {
        fs.renameSync(path.resolve(reportPath, 'sqlite.db'), path.resolve(reportPath, 'old_sqlite.db'));
    } catch (e) {
...
exports.getDataFromDatabase = async (reportPath, reportBuilder) => {
    const database = await new sqlite3.Database(path.resolve(reportPath, 'old_sqlite.db'));
